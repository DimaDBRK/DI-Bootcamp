...
//-> request in address: http://127.0.0.1:5500/DI_Bootcamp_April2023/DI-Bootcamp/Week9/Day1/XP/ex1.html?fname=John&comments=Hello+this+is+a+comment
...
const toJSONTest = JSON.stringify(marioGame);
// debugger;
console.log("Test:", toJSONTest);