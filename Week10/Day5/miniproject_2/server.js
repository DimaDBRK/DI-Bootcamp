...
app.post('/search', smartSearch);
app.post('/search/title', searchFeedTitle);
app.post('/search/category', searchFeedCategory);
...
//smart search
function smartSearch(req, res) {
    
    const body = req.body;
    // console.log("req:", body, "title", body.title )

   if (body.title != undefined) {
    // console.log("titel form")
    res.render("search", {items: getFeedContainedTitle(body.title)})
   } else if (body.category != undefined) {
    // console.log("catgory form")
